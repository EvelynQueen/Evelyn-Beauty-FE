...
const PaymentUnsuccessful = () => {
  return (
    <>
      <div className="hidden sm:flex w-full flex-row justify-between items-center border border-red-300 rounded-xl p-4 gap-6 bg-white shadow-md caret-transparent">
